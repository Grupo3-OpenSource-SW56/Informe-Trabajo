...
<img src="assets/Informe-Trabajo/imgs/CommitsStory.png " alt="Commits" style="width:100%;">
...
|-|-|-|-| 
|,  <br> <img src="assets/pictures profiles/ Murillo.jpg" alt="Imagen del compañero" style="width:40%">|u202212096|Ingenieria de software|C++, SQL, React, Python, Javascript|
|,  <br> <img src="assets/pictures profiles/JorgeOrrego.png" alt="Imagen del compañero" style="width:60%">|u201921734|Ingenieria de software|C++, Python, SQL y Java|
...
| <br> <img src="assets/pictures profiles/CarlosOchoa.jpg" alt="Imagen del compañero" style="width:60%">|u202315945|Ingenieria de software|C++, Python, creativo y amigable|
| <br> <img src = "assets/pictures profiles/marco.png" alt="Imagen del compañero" style="width:60%">|u202018273|Ingenieria de software|C++, Python, SQL, Azure, Trabajador|
...
| Prepared By |  |
| Attendees (to planning meeting) | ,  / ,  / Pachas Chavez, Alejandro Alberto /  |
...
|----|-------|----|-------|-------------|--------------------|-------------|------------------------------------------|
| HU01 | Ver página de inicio atractiva | T01 | Diseño UI/UX de la página de inicio | Se realiza el diseño de interfaz de usuario para la pagina de inicio | 2 | ,  | Done |
| HU01 | Ver página de inicio atractiva | T02 | Implementación Front-end | Se implementa el Front-end con el uso de HTML5, CSS y JavaScript | 2 |  | Done |
| HU01 | Ver página de inicio atractiva | T03 | Optimización SEO | Se realiza una optimización en el codigo para que alcanze un mayor SEO | 3 |  | Done |
| HU01 | Ver página de inicio atractiva | T04 | Pruebas de Usabilidad | Se realizan testing para probar que la página funcione correctamente | 1 | ,  | Done |
...
| HU02 | Registrarme rápidamente | T06 | Integración Backend Registro | Se realiza el Back-end | 6 |  | To-do |
| HU03 | Recibir correo de bienvenida | T07 | Envío Automático de Correo de Bienvenida | Se le envia un correo automatico al usuario nuevo que se ha registrado | 3 | ,  | To-do |
| HU03 | Recibir correo de bienvenida | T08 | Plantilla de Correo de Bienvenida | Se realiza el diseño mejorado del correo de bienvenida | 3 |  | To-do |
| HU04 | Buscar cursos y recursos | T09 | Funcionalidad de Búsqueda de Cursos | Se implementa el sistema para buscar cursos | 8 | ,  | To-do |
| HU04 | Buscar cursos y recursos | T10 | Diseño de Interfaz de Búsqueda | Se realiza el diseño para el sistema de búsqueda | 6 |  | To-do |
| HU10 | Acceder a ejemplos de código y proyectos | T11 | Creación de Ejemplos de Código | Se crean ejemplos de código para llenar los repositorios | 5 |  | To-do |
...
| Alumno | Actividad |
|--------|-----------|
| , | Desarrollo del Capítulo II y desarrollo del Landing Page |
| ,  | Desarrollo del Capítulo IV (Style Guidelines, Information Architecture, Landing Page UI Design, Web Applications UX/UI Design, Web Applications Prototyping ) y V. Desarrollo de la Landing Page |
|  | Desarrollo del Capítulo I y elaboración de la Landing Page |
| Pachas Chavez, Alejandro Alberto | Desarrollo del Capítulo III y V|
|  | Desarrollo del Capítulo IV (Domain-Driven Software Architecture, Software Object-Oriented Design, Database Design)|
...
|--------|------------|-------|-----------------------------------|-------------|--------------------------------------------------------------------|
| 2      | 15/04/2024 | 20:00 | Reunión Virtual mediante Discord | | - , , , Alejandro                            
...
|------|-----------------------------------------------------|------|----------------------------------------------------|----------------------------------------------------------------------------------|--------------------|--------------------|----------------------------------------|
| HU11 | Acceder a ejemplos de código y proyectos           | TK11 | Segmento de ejemplos                              | Crear segmento para que el usuario pueda acceder a ejemplos de código y proyectos | 3                  |        | To Do                                  |
| HU12 | Recibir retroalimentación sobre mi código           | TK12 | Segmento de retroalimentación sobre el código     | Crear segmento en el que el usuario pueda recibir retroalimentación sobre su código | 4                  |        | To Do                                  |
| HU13 | Acceder a comunidad en línea                       | TK13 | Segmento de comunidad                             | Crear segmento en el que el usuario pueda compartir con su comunidad             | 5                  |             | To Do                                  |
...
| HU15 | Colaborar en proyectos de código abierto           | TK15 | Segmento de colaboración en línea                 | Crear segmento para que el usuario pueda colaborar en proyectos de código abierto | 5                  |        | To Do                                  |
| HU16 | Mantenerme actualizado sobre nuevas tecnologías    | TK16 | Segmento de noticias                              | Crear segmento para que el usuario pueda acceder a noticias sobre nuevas tecnologías | 5                  |        | To Do                                  |
| HU17 | Recibir retroalimentación sobre mi arquitectura... | TK17 | Segmento de retroalimentación                     | Crear segmento para que el usuario pueda recibir y observar retroalimentación sobre su arquitectura de diseño | 5                  |        | To Do                                  |
| HU18 | Acceder a herramientas de análisis de rendimie... | TK18 | Segmento de acceso a herramientas de análisis     | Crear segmento para que el usuario pueda acceder a una herramienta de análisis de rendimiento y calidad de código | 5                  |        | To Do                                  |
...
| HU20 | Acceder a recursos de referencia                  | TK20 | Segmento de recursos de referencia                | Crear segmento para que el usuario pueda acceder a recursos de referencia        | 5                  | ,  | To Do          |
...
| Alumno | Actividad |
|--------|-----------|
| Pachas Chavez, Alejandro Alberto |Desarrollo del Frontend, Backend, Reporte |
...
| Sprint | Date       | Time  | Location                          | Prepared By | Attendes                                                           |
|--------|------------|-------|-----------------------------------|-------------|--------------------------------------------------------------------|
| 3    | 30/09/2024 | 17:00 | Reunión Virtual mediante Discord | | - Alejandro Pachas |                          
...
|                     |                                         | TK22 | UI de categorías y pruebas      | Diseñar UI de categorías y realizar pruebas                | 6                 |      | To-Do                                |
...
| HU26                | Acceder a material en varios idiomas    | TK58 | Traducción y pruebas            | Traducir materiales y realizar pruebas                     | 8                |        | To-Do                                |
|                     |                                         | TK59 | UI para selección de idioma     | Diseñar UI para selección de idioma                        | 7                  |        | To-Do                                |
...
|                     |                                         | TK63 | Lectura fácil y pruebas         | Desarrollar lectura fácil y realizar pruebas de accesibilidad | 11                 |        | To-Do                                |
...
| Sprint | Date       | Time  | Location                          | Prepared By | Attendes                                                           |
|--------|------------|-------|-----------------------------------|-------------|--------------------------------------------------------------------|
| 3    | 18/06/2024 | 22:00 | Reunión Virtual mediante Discord |  | , , , , Alejandro Pachas |    
...
| HU02 | Registrarme rápidamente | T06 | Integración Backend Registro | Se realiza el Back-end | 6 |  | Done |
| HU03 | Recibir correo de bienvenida | T07 | Envío Automático de Correo de Bienvenida | Se le envia un correo automatico al usuario nuevo que se ha registrado | 3 | ,  |In Process |
| HU03 | Recibir correo de bienvenida | T08 | Plantilla de Correo de Bienvenida | Se realiza el diseño mejorado del correo de bienvenida | 3 |  | In Process |
| HU04 | Buscar cursos y recursos | T09 | Funcionalidad de Búsqueda de Cursos | Se implementa el sistema para buscar cursos | 8 | ,  | In Process |
| HU04 | Buscar cursos y recursos | T10 | Diseño de Interfaz de Búsqueda | Se realiza el diseño para el sistema de búsqueda | 6 |  | Done |
| HU10 | Acceder a ejemplos de código y proyectos | T11 | Creación de Ejemplos de Código | Se crean ejemplos de código para llenar los repositorios | 5 |  | Done |
...
| HU11 | Acceder a ejemplos de código y proyectos           | TK11 | Segmento de ejemplos                              | Crear segmento para que el usuario pueda acceder a ejemplos de código y proyectos | 3                  |        | Done                                  |
| HU12 | Recibir retroalimentación sobre mi código           | TK12 | Segmento de retroalimentación sobre el código     | Crear segmento en el que el usuario pueda recibir retroalimentación sobre su código | 4                  |        | Done                                  |
| HU13 | Acceder a comunidad en línea                       | TK13 | Segmento de comunidad                             | Crear segmento en el que el usuario pueda compartir con su comunidad             | 5                  |             | Done                                  |
...
| HU15 | Colaborar en proyectos de código abierto           | TK15 | Segmento de colaboración en línea                 | Crear segmento para que el usuario pueda colaborar en proyectos de código abierto | 5                  |        | Done                                  |
| HU16 | Mantenerme actualizado sobre nuevas tecnologías    | TK16 | Segmento de noticias                              | Crear segmento para que el usuario pueda acceder a noticias sobre nuevas tecnologías | 5                  |        | Done                                  |
| HU17 | Recibir retroalimentación sobre mi arquitectura... | TK17 | Segmento de retroalimentación                     | Crear segmento para que el usuario pueda recibir y observar retroalimentación sobre su arquitectura de diseño | 5                  |        | Done                                  |
| HU18 | Acceder a herramientas de análisis de rendimie... | TK18 | Segmento de acceso a herramientas de análisis     | Crear segmento para que el usuario pueda acceder a una herramienta de análisis de rendimiento y calidad de código | 5                  |        | Done                                  |
...
| HU20 | Acceder a recursos de referencia                  | TK20 | Segmento de recursos de referencia                | Crear segmento para que el usuario pueda acceder a recursos de referencia        | 5                  | ,  | Done          |
| HU23                | Recibir recomendaciones personalizadas  | TK41 | Algoritmo y recolección de datos | Desarrollar algoritmo y recolectar datos                   | 6                 | Alejandro      | To-Do                                |
|                     |                                         | TK43 | Integración y preferencias      | Integrar recomendaciones y configurar preferencias         | 6                | Marco      | To-Do                                |
|                     |                                         | TK45 | Adaptación y pruebas            | Adaptar el algoritmo y realizar pruebas                    | 8                | Carlos       | To-Do                                |
| HU24                | Acceder a material de estudio descargable | TK47 | Preparación y actualización     | Preparar y actualizar el material                          | 4                | Carlos   | To-Do                                |
...
| Alumno | Actividad |
|--------|-----------|
| , | Reporte (5.3 y 5.4), Desarrollo del Frontend |
| ,  | Desarrollo y despliegue del Frontend, Reporte |
|  | Desarrollo del Backend y Frontend |
| Pachas Chavez, Alejandro Alberto | Desarrollo del Backend y Frontend|
|  | Reporte (5.2.4.3 al 5.2.4.8) y desarrollo del Backend |
...
**Enlace del backend de la aplicación:**: https://fastlearners.azurewebsites.net/swagger-ui/index.html#/
